...
Для доступа к элементам массива в Zig используется индексация через квадратные скобки с нумерацией с нуля. При этом Zig обеспечивает безопасный доступ к элементам, проверяя границы массива:
