...
Также пре выводе данных мы можем использовать спецификаторы для вывода в различных форматах, например, `%d` для целых чисел, `%f` для чисел с плавающей точкой и `%s` для строк. Вот полный список спецификаторов:
