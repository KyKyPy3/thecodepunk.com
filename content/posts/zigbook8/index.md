...
Также при выводе данных мы можем использовать спецификаторы для вывода в различных форматах, например, `%d` для целых чисел и `%s` для строк. Вот полный список спецификаторов:
